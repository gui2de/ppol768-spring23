...
global q2b "$wd/q2_CIV_Section_0.dta"
...
tempfile populationdensity 
save populationdensity, replace emptyok 

use "$q2b", clear 

decode b06_departemen, gen(department)

merge m:1 department using `populationdensity'
...
// the above calculates the eucledian distance and then minimizes the euclidian
// distance and clusters based on number of enumerators marked in k. 

rename _clus_1 enumerator
...
save `2015', replace emptyok

joinby region district ward using `2010'
...
** i am stuck on how to identify whether something is split? While it is clear 
**this comes from the score, that score variable doesnt make sense. 
