...
* Eseentially my DGP states that the formalization of a business by a female entrepenure increase business profits by 2.5% with the exception of the noise in the model. 
...
** Generate strata groups 
	...
	clear 
		set obs 2  // number of localities in Bogota
		gen localitie = _n
		gen leffect = rnormal(0,2) // localitie effect
		*gen urban = rnormal() <0.5
