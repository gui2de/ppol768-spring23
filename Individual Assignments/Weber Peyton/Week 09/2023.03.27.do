...
*Use code used in class that I believe works to allow you to designate the sample size later on (?) 
...
*Create ten classrooms in each school for some reason, because we did it in class. 
expand 10
*Generate classroom IDs
...
forvalues i=1/2 {
	...
	tempfile sims
	simulate beta1 = r(Beta1) beta2 = r(Beta2) beta3 = r(Beta3) beta4 = r(Beta4) beta5 = r(Beta5) ///
	, reps(500) seed(4321) saving(`sims2') ///
...
*My code keeps breaking here, and I don't understand why!!! I get different error messages every time. 
